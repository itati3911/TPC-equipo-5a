<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="TPC_equipo_5a.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mb-3 d-flex justify-content-center">
        ...
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary me-3" Text="Registrarme" />
